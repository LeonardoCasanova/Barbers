...
public class CarroService {
    private static final String URL = "http://www.livroandroid.com.br/livro/carros/v2/carros_esportivos.json";
    private static final boolean LOG_ON = false;
    private static final String TAG = "CarroService";
    public static List<Carro> getCarros(Context context) throws IOException {
        String url = URL;
    ...
    private static List<Carro> parserJSON(Context context, String json) throws IOException {
        ...
        try {
            ...
            JSONObject jsonCarro;
            for (int i = 0; i < jsonCarros.length(); i++) {

                jsonCarro = new JSONObject(jsonCarros.getString(i));
                Carro c = new Carro();
